...
def main(args):
    ...
    if args.train_path_cyp:
        trainf,testf = cyp_concat(trainf, testf, args.train_path_cyp, args.test_path_cyp)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path_cyp', type=str, required=True, help='Path to the training CSV file')  
    parser.add_argument('--test_path_cyp', type=str, required=True, help='Path to the testing CSV file')  
